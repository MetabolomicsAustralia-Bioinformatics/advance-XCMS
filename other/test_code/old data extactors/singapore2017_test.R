...
#setwd("/home/socall/projects/vinod/singapore2017/batch1/")
#getwd()
dir()
...
ref <- "/media/sf_VM_share/singapore_batch5_pbqd/pbqd/pbQC71.mzXML"
...
#
##############################################################################
xs_filled <- fillPeaks(xs_align, method="chrom", nSlaves=8)
